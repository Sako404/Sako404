<!--
  Source of truth: this file. Hand-written sections are edited directly.
  The two sections wrapped in `<!-- NAME:START -->` / `<!-- NAME:END -->`
  markers are regenerated on a schedule by .github/workflows/update-readme.yml
  (scripts/update_readme.py) — edit the script, not the markdown, for those.
  The "GitHub Activity" image is regenerated by .github/workflows/metrics.yml.
  See docs/ARCHITECTURE.md for why this repo is built the way it is.
-->
